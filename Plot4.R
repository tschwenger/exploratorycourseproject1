...
voltage <- as.numeric(power$Voltage, col.names = "voltage", na.rm = FALSE)
reactivepower <- as.numeric(power$Global_reactive_power, col.names = "reactivepower", na.rm = FALSE)

png("plot4.png", width=480, height=480)
par(mfrow = c(2,2))

plot(datetime, activepower, type = "l", ylab= "Global Active Power")
...
legend("topright", c("Sub_metering_1","Sub_metering_2","Sub_metering_3"), lty=1, lwd=0.5, col=c("black","red","blue"))
